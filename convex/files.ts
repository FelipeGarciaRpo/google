...
export const createFile = mutation({
    ...
    handler: async (ctx, args)=>{
        ...
        if(existing) throw new Error("File alredy exists");
...
export const createFolder = mutation({
    ...
    handler: async (ctx, args)=>{
        ...
        if(existing) throw new Error("Folder alredy exists");
...
export const renameFile = mutation({
    ...
    handler: async (ctx, args)=>{
        ...
        if(existing){
            throw new Error(
                `A ${file.name} with this name alredy exists in the location`
            );
        }
